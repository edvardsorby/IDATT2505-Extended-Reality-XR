...
public class Exercise2 extends GLCanvas implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glTranslatef(-1.5f, 0.0f, -15.0f);
        gl.glColor3f(1.0f,1.0f,0.0f);
        gl.glBegin(GL_POINTS);
        gl.glVertex3dv(coordinates[0],0);
        gl.glEnd();

        gl.glTranslatef(-10.0f, 0.0f, 0.0f);
        gl.glColor3f(0.0f,1.0f,0.0f);
        gl.glBegin(GL_LINES);
        gl.glVertex3dv(coordinates[1],0);
        gl.glVertex3dv(coordinates[2],0);
        gl.glEnd();

        gl.glTranslatef(2.0f, -2.0f, 0.0f);
        gl.glColor3f(0.0f,0.5f,0.5f);
        gl.glBegin(GL_LINE_STRIP);
        gl.glVertex3dv(coordinates[3],0);
        gl.glVertex3dv(coordinates[4],0);
        gl.glVertex3dv(coordinates[5],0);
        gl.glEnd();


        gl.glTranslatef(5.0f, -4.0f, 0.0f);
        gl.glColor3f(0.3f,0.6f,0.1f);
        ...
        gl.glColor3f(0.2f,1.0f,0.8f);
        gl.glVertex3dv(coordinates[1], 0);
        gl.glColor3f(0.5f,0.4f,0.5f);
        gl.glVertex3dv(coordinates[0], 0);
        gl.glVertex3dv(coordinates[5], 0);
        gl.glColor3f(0.9f,0.7f,0.3f);
        gl.glVertex3dv(coordinates[4], 0);
        gl.glEnd();
